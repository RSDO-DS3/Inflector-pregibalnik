...
class VectorizeLemma:
    ...
    def __init__(self, resources_directory):
        ...
        self.ending_parts_for_verbs = [line.strip("\n") for line in open(os.path.join(resources_directory, "ending_parts_for_verbs.tsv"), "r", encoding="UTF-8").readlines()]
        self.ending_parts_for_masculine_nouns = [line.strip("\n") for line in open(os.path.join(resources_directory, "ending_parts_for_masculine_nouns.tsv"), "r", encoding="UTF-8").readlines()]
        self.ending_parts_for_feminine_nouns = [line.strip("\n") for line in open(os.path.join(resources_directory, "ending_parts_for_feminine_nouns.tsv"), "r", encoding="UTF-8").readlines()]
        self.ending_parts_for_neuter_nouns = [line.strip("\n") for line in open(os.path.join(resources_directory, "ending_parts_for_neuter_nouns.tsv"), "r", encoding="UTF-8").readlines()]
        self.ending_parts_for_adjectives = [line.strip("\n") for line in open(os.path.join(resources_directory, "ending_parts_for_adjectives.tsv"), "r", encoding="UTF-8").readlines()]
        self.ending_parts_for_adverbs = [line.strip("\n") for line in open(os.path.join(resources_directory, "ending_parts_for_adverbs.tsv"), "r", encoding="UTF-8").readlines()]
...
class PatternPredictor:
    ...
    def __init__(self, resources_directory, models_directory):

        # INSTANTIATE LEMMA VECTORIZER
        self.lemma_vectorizer = VectorizeLemma(resources_directory=resources_directory)

        # LOAD PREDICTION MODELS
        self.logreg_verbs = pickle.load(open(os.path.join(models_directory, "logreg_verbs.sav"), "rb"))
        self.logreg_adverbs = pickle.load(open(os.path.join(models_directory, "logreg_adverbs.sav"), "rb"))
        self.logreg_adjectives = pickle.load(open(os.path.join(models_directory, "logreg_adjectives.sav"), "rb"))
        self.logreg_masculine_nouns = pickle.load(open(os.path.join(models_directory, "logreg_masculine-nouns.sav"), "rb"))
        self.logreg_feminine_nouns = pickle.load(open(os.path.join(models_directory, "logreg_feminine-nouns.sav"), "rb"))
        self.logreg_neuter_nouns = pickle.load(open(os.path.join(models_directory, "logreg_neuter-nouns.sav"), "rb"))
...
class FormGenerator:
    ...
    def __init__(self, resources_directory):
        ...
        self.file_with_patterns_for_form_generation = open(os.path.join(resources_directory, "patterns_for_generation.tsv"), "r", encoding="UTF-8").readlines()
        ...
        self.list_of_msds_for_lemmas = [line.strip("\n") for line in open(os.path.join(resources_directory,"list_of_msds_for_lemmas.tsv"), "r", encoding="UTF-8").readlines()]
...
class PatternCodeRemapper:
    ...
    def __init__(self, resources_directory):
        ...
        for line in open(os.path.join(resources_directory,"pattern_remapping.tsv"), "r", encoding="UTF-8").readlines()[1:]:  # SKIP HEADER
