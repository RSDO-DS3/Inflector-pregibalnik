...
class SloveneG2P:
    ...
    def __init__(self, data_directory, representation_option, phoneme_set_option, output_option):
        self.phoneme_set_file_path = os.path.join(data_directory, "SloveneG2P_phoneme_set.json")
        self.conversion_file_path = os.path.join(data_directory, "table_of_obstruent_conversions.tsv")
        ...
        file_with_schwa_rules = open(os.path.join(data_directory, "schwa_rules.tsv"), "r", encoding="UTF-8").readlines()
